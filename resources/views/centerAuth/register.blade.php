    ...
    <div class="container">
        <div class="row" style="margin-top: 45px; align-content: center">
            <div class="col-md-4 col-md-offset-4" style="align: center;">
                ...
                <br>
                <form action="{{route('center-auth.save')}}" method="post">
                    ...
                    <div class="form-group">
                        <labbel>Center Name</labbel>
                        <input type="text" class="form-control" name="name" placeholder="Center Name">
                        <spam class="text-danger">@error('name'){{$message}} @enderror</spam>
                    </div>
                    <br>
                    <div class="form-group">
                        <labbel>Center Email</labbel>
                        <input type="text" class="form-control" name="email" placeholder="Center email">
                    ...
                    <br>
                        <div class="form-group">
                            <labbel>Center Address</labbel>
                            <input type="text" class="form-control" name="name" placeholder="Name">
                            <spam class="text-danger">@error('name'){{$message}} @enderror</spam>
                        </div>
                    <button type="submit" class="btn btn-primary">Sign up</button>
                </form>
                <h6 style="padding-top: 30px;padding-right: 30px;">Already have an Account  <a href="../center-auth/login"> Login Now</a></h6>
            </div>
