        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li>
                        <h6 style="padding-top: 30px;padding-right: 30px;"><a href="/customer/sale">Vehicle Sale Area</a></h6>

                    </li>
                    <li>
                        <h6 style="padding-top: 30px;padding-right: 30px;"><a href="">Contact us</a></h6>
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><h6 style="padding-top: 15px"></h6></span>
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-lg-8 mt-5 mt-lg-0">
                                ...
                                <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                                    ...
                                    <div class="text-center"><button class="btn-primary" type="submit" >Send Message</button cl></div>
                                </form>
                                <br><br>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; kandy vehicle 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
