@extends('customer.jobs.layout3')
@section('content')
    <div class="card">
        <div class="card-header"><h1 style="align-content: center">Edit your Vehicle Fault</h1></div>
        <div class="card-body">
            ...
            <form action="{{ route('customer.jobs.update',$job->id) }}" method="post">
                @csrf
                @method('put')
                <hr>
